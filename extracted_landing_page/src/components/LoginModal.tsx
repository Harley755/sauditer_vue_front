...
export function LoginModal({ isOpen, onClose, onSuccess, onSwitchToSignup }: LoginModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // For demo purposes, default to 'manager' type
    onSuccess('manager');
  };
        ...
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
            <motion.div
              ...
              className="bg-slate-900 border border-slate-800 rounded-2xl max-w-md w-full p-8 relative"
            ...
            >
              ...
              <div className="text-center mb-8">
                ...
                <h2 className="text-white text-2xl mb-2">Connexion</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center justify-between text-sm">
                  <label className="flex items-center gap-2 text-slate-400 cursor-pointer">
                    <input
                      type="checkbox"
                      className="w-4 h-4 rounded border-slate-700 bg-slate-800/50 text-cyan-500 focus:ring-cyan-500 focus:ring-offset-0"
                    />
                    Se souvenir de moi
                  </label>
              ...
              <div className="space-y-3">
                ...
                <button className="w-full py-3 border border-slate-700 text-slate-300 rounded-lg hover:bg-slate-800/50 transition-all flex items-center justify-center gap-2">
